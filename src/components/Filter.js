            ...
            <ul>
              ...
              <li>
                <div className="dropdown-Main">
                  <div className="dropdown-head-gender" onClick={() => toggleOption('gender')}>
                    Gender
                  </div>
                  <div className={`dropdown-options ${openDropdown === 'gender' ? 'show' : ''}`}>
              ...
              <li>
                <div className="dropdown-Main">
                  <div className="dropdown-head-price" onClick={() => toggleOption('price')}>
                    Shop By Price
                  </div>
                  <div className={`dropdown-options ${openDropdown === 'price' ? 'show' : ''}`}>
                    ...
                    <div className="dropdown-option-price2">
                      ...
                      <label htmlFor="cat-price2"> &#8377; 2500 - &#8377; 9000</label>
                    </div>
                    <div className="dropdown-option-price3">
                      <input type="checkbox" id="cat-price3" />
                      <label htmlFor="cat-price3"> &#8377; 9000 - &#8377; 15000</label>
                    </div>
              ...
              <li>
                <div className="dropdown-Main">
                  <div className="dropdown-head-size" onClick={() => toggleOption('size')}>
                    Size
                  </div>
                  <div className={`dropdown-options ${openDropdown === 'size' ? 'show' : ''}`}>
              ...
              <li>
                <div className="dropdown-Main">
                  <div className="dropdown-head-sports" onClick={() => toggleOption('sports')}>
                    Sports
                  </div>
                  <div className={`dropdown-options ${openDropdown === 'sports' ? 'show' : ''}`}>

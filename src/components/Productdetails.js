                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  ...
                  <div class="flex mb-4">
                    <span class="flex items-center">
                      ...
                      <span class="text-black ml-3">4 Reviews</span>
                    </span>
                  ...
                  <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                    ...
                    <div class="flex ml-6 items-center">
                      ...
                      <div class="relative">
                        <select class="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-black focus:border-black text-base pl-3 pr-10">
                          <option>SM</option>
                          <option>M</option>
                          <option>L</option>
                          <option>XL</option>
                  ...
                  <div class="flex">
                    ...
                    <button class="flex ml-auto text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-black-600 rounded">
                      Add To Cart
                    </button>
